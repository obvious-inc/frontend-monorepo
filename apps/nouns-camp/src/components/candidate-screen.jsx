...
import { stringify as stringifyTransaction } from "@/utils/transactions";
import {
  normalizeId,
...
import { buildActions as buildActionsFromTransactions } from "@/utils/transactions";
import {
...
import { useProposalCandidateSimulation } from "@/hooks/simulation";
...
const PromoteCandidateDialog = React.lazy(
  () => import("@/components/promote-candidate-dialog"),
);
