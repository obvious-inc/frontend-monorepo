...
// This identifies a user endorsement of another post.
//
// Example:
//
//     +1
...
/**
 * Format a repost with the standard +1 and blockquote format
 * @param {string} targetReason - The original post content to repost
 * @returns {string} Formatted repost text
 */
export const formatRepost = (targetReason) =>
  `+1\n\n${markdownUtils.blockquote(targetReason.trim())}`;

/**
 * Format a reply with the standard @address, body, and blockquote format
 * @param {Object} params 
 * @param {Object} params.target - The target post being replied to
 * @param {string} params.body - The reply content
