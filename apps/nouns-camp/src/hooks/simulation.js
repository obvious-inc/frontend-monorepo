...
export const useWriteContractSimulation = () => {
  const simulateContractAsync = async ({
    chainId,
    address,
    abi,
    functionName,
    ...
    if (!simulation?.status) {
      ...
      console.log("simulation successful", simulationUrl);
    }

    return;
  };

  return { writeContractSimulationAsync: simulateContractAsync };
};
