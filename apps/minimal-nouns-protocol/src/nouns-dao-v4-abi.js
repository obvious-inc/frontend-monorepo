export default [
  ...
  { inputs: [], name: "InvalidNounsAddress", type: "error" },
  { inputs: [], name: "InvalidTimelockAddress", type: "error" },
  ...
  { inputs: [], name: "UnsafeUint16Cast", type: "error" },
  { inputs: [], name: "VotesBelowProposalThreshold", type: "error" },
  {
    anonymous: false,
    inputs: [
      {
  ...
  },
  {
    ...
    name: "executeFork",
    outputs: [
      { internalType: "address", name: "forkTreasury", type: "address" },
      { internalType: "address", name: "forkToken", type: "address" },
    ],
    stateMutability: "nonpayable",
    type: "function",
  },
    ...
    inputs: [
      ...
      { internalType: "address", name: "vetoer_", type: "address" },
      {
        components: [
          ...
          { internalType: "uint32", name: "queuePeriod", type: "uint32" },
          { internalType: "uint32", name: "gracePeriod", type: "uint32" },
        ],
  ...
  {
    inputs: [
      { internalType: "uint256", name: "firstProposalId", type: "uint256" },
      { internalType: "uint256", name: "lastProposalId", type: "uint256" },
        ...
        components: [
          ...
          { internalType: "uint32", name: "clientId", type: "uint32" },
          {
            components: [
              ...
              { internalType: "uint32", name: "txs", type: "uint32" },
            ],
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: "bytes32", name: "txsHash", type: "bytes32" },
        ],
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "enum NounsDAOTypes.ProposalState",
        name: "",
        type: "uint8",
      },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "bytes[]", name: "calldatas", type: "bytes[]" },
      { internalType: "string", name: "description", type: "string" },
      { internalType: "string", name: "updateMessage", type: "string" },
    ],
    name: "updateProposal",
    outputs: [],
    stateMutability: "nonpayable",
