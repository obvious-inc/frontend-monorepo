export default [
  ...
  { inputs: [], name: "ProposerAlreadyHasALiveProposal", type: "error" },
  ...
  {
    inputs: [
      { internalType: "address", name: "newTimelock", type: "address" },
      { internalType: "address", name: "newTimelockV1", type: "address" },
