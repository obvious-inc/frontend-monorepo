...
const stringifyBlocks = (blockElements)=>blockElements.map(stringifyElement).join("")// Gets rid of the the outer paragraph line breaks, I dunno
    .replace(/^[\n]|[\n]$/g, "");
...
var message = /*#__PURE__*/Object.freeze({
  ...
  stringifyBlocks: stringifyBlocks
});
